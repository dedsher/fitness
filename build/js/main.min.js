...
var _initSliders = require("./modules/sliders/init-sliders");
...
var _form = require("./vendor/form/form");
// ---------------------------------
...
},{"./modules/accordion/init-accordion":2,"./modules/init-video":3,"./modules/price":4,"./modules/sliders/init-sliders":5,"./modules/tabs/init-tabs":6,"./utils/ios-vh-fix":8,"./vendor/form/form":11}],2:[function(require,module,exports){
"use strict";
...
},{"../../vendor/accordions":9}],3:[function(require,module,exports){
"use strict";
...
var videoWrapper = document.querySelector('.about__video-wrapper');
var frame = videoWrapper.querySelector('iframe');
...
exports.initPrice = void 0;
var priceCards = document.querySelectorAll('.price b');
var tabsWrapper = document.querySelector('.price__tabs');
...
var currentTab = 0;
var prevTabElement = tabs[0];
var currentPrice = prices[tabToPrice[currentTab]];
...
var setPrices = function setPrices() {
  priceCards.forEach(function (card, index) {
...
var onTabClick = function onTabClick(evt) {
  var currentTabElement = evt.target;
...
var initPrice = exports.initPrice = function initPrice() {
  setActiveTab();
  setPrices();
...
var slidersWrappers = document.querySelectorAll('[data-swiper]');
var slidersSettings = {
  jury: {
...
var initSliderJury = function initSliderJury() {
  var sliders = [];
  slidersWrappers.forEach(function (wrapper, index) {
    var currentSliderName = wrapper.dataset.swiper;
    sliders[index] = new _swiper.default(wrapper, slidersSettings[currentSliderName]);
  });
};
...
},{"../../vendor/swiper":17}],6:[function(require,module,exports){
"use strict";
...
},{"../../vendor/tabs":18}],7:[function(require,module,exports){
"use strict";
